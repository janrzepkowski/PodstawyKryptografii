...
public class AES {
    ...
    static private final char[] inverseSbox = {
    ...
    static private final char[] multiply2 = {
    ...
    static private final char[] multiply3 = {
    ...
    static private final char[] multiply9 = {
    ...
    static private final char[] multiply11 = {
    ...
    static private final char[] multiply13 = {
    ...
    static private final char[] multiply14 = {
    ...
    public void invSubBytes(byte[][] table) {
        for (int i = 0; i < table.length; i++) {
            for (int j = 0; j < table[i].length; j++) {
                table[i][j] = (byte) inverseSbox[Byte.toUnsignedInt(table[i][j])];
            }
        }
    }
    ...
    private void subWord(byte[] key) {
        for (int i = 0; i < key.length; i++) {
            key[i] = (byte) sbox[Byte.toUnsignedInt(key[i])];
        }
    }
...
//            System.out.println(i + " " + rounds + " " + startIndex + " " + keyExpansion.length);
    ...
    public byte[][] addRoundKey1(byte[][] table, byte[][] key, int round) {
